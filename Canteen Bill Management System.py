...
root.title("Canteen Bill Management System")
...
#=================================Info================================================================================
lblInfo = Label(Tops, font=('arial',50,'bold'),text="Canteen Bill Management System",fg="Steel Blue", bd=10, anchor='w')
...
lblCost = Label(f1,font=('arial', 16,'bold'), text="Costof Meal", bd=16, anchor='w')
